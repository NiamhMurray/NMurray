...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 15 15:04:25 2020
...
# =============================================================================
    ...
    plot_series(timarr, windarr, 'Wind Speed  (m/s)', 'Wind Speed Time Series in Paris, \n during Storm Martin, 20/12/1999-30/12/1999')
    median, upper_quartile, v98 = plot_histogram(windarr, 35, "peachpuff", "Frequency of Windspeed \n in Paris 1979-2018","Wind Speed", "Frequency")  
    ssi_index_paris_martin = np.array(ssi_index(windarr, 8.09))    
    acum_index_paris_martin = sum(ssi_index_paris_martin)
