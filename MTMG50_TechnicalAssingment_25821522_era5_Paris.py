...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 17:50:43 2020
...
# =============================================================================
    ...
    #Paris using ERA5 Data
    plot_series(years, windarr, 'Wind Speed  (m/s)', "dimgray", \
                'ERA5 Wind Speed Time Series \n for Paris in 1979-2018')
    
    #Using the plot histogram function plot a histogram of wind speeds in Paris
    #also returns the median, upper quartile and 98th percentile 
    median, upper_quartile, v98, v50, v75 = plot_histogram(windarr, 35, "palegreen", \
                                                 " Historical Frequency of Windspeed \n in Paris 1979-2018 using ERA5 data","Wind Speed (m/s)", "Frequency")  
    
    #compute the SSI index for Paris for each time step in the entire data set
    ssi_index_paris = np.array(ssi_index(windarr, v98))    
    
    #compute the total SSI index for hamburg over the dataset
    acum_index_paris = sum(ssi_index_paris)
